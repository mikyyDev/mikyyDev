...
const michael = {
  location: "Ethiopia 🇪🇹",
  education: "Information Science Student",
...
<table>
  <tr>
    <td width="50%">
      <h3>✈️ Travel Agency Dashboard</h3>
      <p>Full-stack SaaS dashboard — client management, bookings & AI-powered itinerary generation.</p>
      <p><strong>Stack:</strong> React · FastAPI · AI</p>
    </td>
    <td width="50%">
      <h3>🤖 RAG Assistant (AAU)</h3>
      <p>AI assistant answering questions about Addis Ababa University using Retrieval-Augmented Generation.</p>
      <p><strong>Stack:</strong> Python · RAG · NLP</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>🌐 Portfolio Website</h3>
      <p>Responsive personal site with clean UI and smooth interactions.</p>
      <p><strong>Stack:</strong> HTML · CSS · JavaScript</p>
    </td>
    <td width="50%">
      <h3>🔜 More coming soon...</h3>
      <p>Follow my journey on GitHub to see what I build next.</p>
      <a href="https://github.com/mikyyDev">⭐ Star my repos</a>
    </td>
  </tr>
</table>
...
*Open to collaborations, feedback, and exciting opportunities*
